...
let eval_add arg1 arg2 =
        let a, b = match (arg1, arg2) with
                | Atom(arg1), Atom(arg2) -> (int_of_string arg1, int_of_string arg2)
                | _,_ -> raise (Error "Matching error")
        in Atom (string_of_int (a + b))
...
let eval_addl arg =
        let rec aux = function
                ...
                | _ -> raise (Error "Matching error")
        in Atom (string_of_int (aux arg))

let atom_of_bool = function
        | true -> Atom "t"
        | false -> Atom "nil"
...
let all_builtins =
  [ (* Special forms *)
    ...
    "add", SpecialForm2 eval_add;
    "addl", SpecialForm1 eval_addl;
    "sub", SpecialForm2 eval_sub;
    "mul", SpecialForm2 eval_mul;
    "leq", SpecialForm2 eval_leq;
    "geq", SpecialForm2 eval_geq;
